...
class PetMapServiceTest {
    ...
    @Test
    @DisplayName("Should return pet by existing id")
    ...
    @Test
    @DisplayName("Should return empty pet when id is not found")
    ...
    @Test
    @DisplayName("Should return null when id = null")
    void findByIdNullId() {
    ...
    @Test
    @DisplayName("Should save pet when id is already exist")
    void saveExistingId() {
    ...
    @Test
    @DisplayName("Should save duplicate id")
    ...
    @Test
    @DisplayName("Should delete pet with wrong id")
    ...
    @Test
    @DisplayName("Should delete pet with null id")
    void deleteNull() {
    ...
    @Test
    @DisplayName("Should delete pet by id with wrong id")
